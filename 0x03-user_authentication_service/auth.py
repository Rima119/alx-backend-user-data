...
class Auth:
    ...
    def register_user(self, email: str, password: str) -> User:
        """create new user and save to the db and return
        User object"""
        try:
    ...
    def valid_login(self, email: str, password: str) -> bool:
        """locates user by email and check if password matches
        with bcrypt"""
        try:
            user = self._db.find_user_by(email=email)
        except NoResultFound:
    ...
    def create_session(self, email: str) -> str:
        """locate user by email, generate new UUID and store it
    ...
    def get_reset_password_token(self, email: str) -> str:
        """locate user by email. if user exists, generates a
    ...
    def update_password(self, reset_token: str, password: str) -> None:
        """returns None - if user exist, hash the password
